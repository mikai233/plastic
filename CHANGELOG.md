...
## [0.3.5] - 2025-11-26
### Changed
- Improved Audio handling, for smoother audio.
- More accurate timing emulation.

## Fixed/Security
- Updated almost all dependencies that will fix several issues from old versions and improved security.
...
[Unreleased]: https://github.com/Amjad50/plastic/compare/v0.3.5...HEAD
[0.3.5]: https://github.com/Amjad50/plastic/compare/v0.3.4...v0.3.5
